<script lang="ts">
	import { user, editingAttendedEvent, userAttendedEvents } from '../modules/stores';
	...
	<PopModal show={showAttendanceForm} onClose={onAttendanceFormToggle}>
		<div class="pop-modal-form">
			...
			>
				Update</button
			>
			<button on:click={onAttendanceFormToggle} disabled={submitting}>Cancel</button>
